Pod::Spec.new do |s|
  ...
  s.version      = "2.0.5"
  s.summary      = "YTKNetwork is a high level request util based on AFNetworking. 2.0.5：新增上传进度block"
  ...
  s.source        = { :git => "https://github.com/BestKai/YTKNetwork-YKUpdate.git", :tag => s.version.to_s }
